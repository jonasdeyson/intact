...
OVERVIEW  (intact guide overview)
---------------------------------
...
SAFETY MODEL  (intact guide safety)
-----------------------------------
...
ENCODINGS  (intact guide encoding)
----------------------------------
...
LINE NUMBERS AND RANGES  (intact guide ranges)
----------------------------------------------
...
SUPPLYING TEXT  (intact guide text)
-----------------------------------
...
EXIT CODES  (intact guide exit-codes)
-------------------------------------
...
BATCH SCRIPTS  (intact guide batch)
-----------------------------------
